...
= 3.3.2 =
* Fixed: Security vulnerability (CSV Injection) reported by Farid Narimanov

= 3.3.1 =
* Fixed: Security vulnerability reported by Farid Narimanov
...
= 3.2.9 =
* Fixed: Tip selected for customer is not saved
...
= 3.2.6 =
* Added: Option to round the tip amount when calculated by percentage
...
= 3.2.0 =
* Updated: Class reports (Thanks to Danijel)
