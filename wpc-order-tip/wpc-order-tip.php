...
! defined( 'WPCOT_VERSION' ) && define( 'WPCOT_VERSION', '3.3.0' );
...
! defined( 'WPCOT_REVIEWS' ) && define( 'WPCOT_REVIEWS', 'https://wordpress.org/support/plugin/wpc-order-tip/reviews/' );
