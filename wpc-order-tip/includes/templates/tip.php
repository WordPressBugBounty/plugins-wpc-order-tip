    ...
    <div class="wpcot-tip-content">
        <div class="wpcot-tip-line">
            ...
            <div class="input-panel">
                <label>
                    <input type="text" value="<?php echo esc_attr( $name ); ?>" class="wpcot-tip-name input-block"
                           name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][name]' ); ?>" required/>
                </label>
            </div>
        </div>
        <div class="wpcot-tip-line">
            ...
            <div class="input-panel">
                <label>
                    <textarea class="input-block"
                              name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][desc]' ); ?>"><?php echo esc_html( $desc ); ?></textarea>
                </label>
            </div>
        </div>
        <div class="wpcot-tip-line">
...
<input type="text" value="<?php echo esc_attr( $value['label'] ); ?>"
       placeholder="<?php esc_attr_e( 'label', 'wpc-order-tip' ); ?>"
       name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][values][' . $count . '][label]' ); ?>"/>
</label>
			                    </span>
                                <span class="wpcot-value-wrapper hint--top"
                                      aria-label="<?php esc_attr_e( 'Set a value using a number (eg. "10") or percentage (eg. "15%" of order subtotal)', 'wpc-order-tip' ); ?>">
			                        <label>
<input type="text" value="<?php echo esc_attr( $value['value'] ); ?>"
       placeholder="<?php esc_attr_e( 'value', 'wpc-order-tip' ); ?>"
       name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][values][' . $count . '][value]' ); ?>"/>
</label>
			                    </span>
                                <span class="wpcot-remove-value hint--top"
                                      aria-label="<?php esc_attr_e( 'remove', 'wpc-order-tip' ); ?>">&times;</span>
                            </div>
                            <?php
                            $count ++;
                        }
                ...
                <div class="wpcot-new-value">
                    <button class="button wpcot-add-value" type="button" data-key="<?php echo esc_attr( $key ); ?>"
        ...
        <div class="wpcot-tip-line">
            ...
            <div class="input-panel">
                <label>
                    <input type="text" name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][default]' ); ?>"
            ...
            <div class="input-panel">
                ...
                <div class="wpcot-show-if-custom">
                    <span class="hint--top" aria-label="<?php esc_attr_e( 'min', 'wpc-order-tip' ); ?>">
                        <label>
<input type="number" name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][custom_min]' ); ?>"
       value="<?php echo esc_attr( $custom_min ); ?>" placeholder="<?php esc_attr_e( 'min', 'wpc-order-tip' ); ?>"
       style="width: 80px"/>
</label>
                    </span> <span class="hint--top" aria-label="<?php esc_attr_e( 'step', 'wpc-order-tip' ); ?>">
                        <label>
<input type="number" name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][custom_step]' ); ?>"
       value="<?php echo esc_attr( $custom_step ); ?>" placeholder="<?php esc_attr_e( 'step', 'wpc-order-tip' ); ?>"
       style="width: 80px"/>
</label>
                    </span> <span class="hint--top" aria-label="<?php esc_attr_e( 'max', 'wpc-order-tip' ); ?>">
                        <label>
<input type="number" name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][custom_max]' ); ?>"
       value="<?php echo esc_attr( $custom_max ); ?>" placeholder="<?php esc_attr_e( 'max', 'wpc-order-tip' ); ?>"
       style="width: 80px"/>
</label>
                    </span>
                    <span class="hint--top" aria-label="<?php esc_attr_e( 'default value', 'wpc-order-tip' ); ?>">
                        <label>
<input type="number" name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][custom_value]' ); ?>"
       value="<?php echo esc_attr( $custom_value ); ?>"
       placeholder="<?php esc_attr_e( 'default value', 'wpc-order-tip' ); ?>" style="width: 80px"/>
</label>
                    </span>
                </div>
            </div>
        ...
        <div class="wpcot-tip-line">
            ...
            <div class="input-panel">
                <p class="description"><?php esc_html_e( 'Select which user roles that can see this tip group.', 'wpc-order-tip' ); ?>
                    <span style="color: #c9356e">This feature is only available on the Premium Version.</span></p>
                <label>
                    <select name="<?php echo esc_attr( 'wpcot_tips[' . $key . '][roles][]' ); ?>" multiple
                            class="wpcot_roles_select">
                        <?php
                        global $wp_roles;
